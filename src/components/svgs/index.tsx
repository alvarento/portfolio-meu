...
export { default as SchoolIcon } from '../../assets/icons/school.svg';
export { default as RocketLauchIcon } from '../../assets/icons/rocket-launch.svg';
export { default as BullseyeArrowIcon } from '../../assets/icons/bullseye-arrow.svg';
export { default as BooksStudyIcon } from '../../assets/icons/books-study.svg';

export { default as AboutTitleIcon } from '../../assets/icons/about.svg';
export { default as AboutMimIcon } from '../../assets/icons/account.svg';
export { default as ToolsIcon } from '../../assets/icons/tools.svg';
